                        ...
                        targetTime.flatMap { targetTime =>
                            ...
                            def pushLoop: ZIO[Client, Throwable, Unit] =
                                for
                                    ...
                                    adjustedDelay = if delay.isNegative then
                                                        delay.plusHours(configuration.updateInterval)
                                                    else delay
                            ...
                            if targetTime.isAfter(OffsetDateTime.MIN) && targetTime.isBefore(OffsetDateTime.MAX) then
                                pushLoop
